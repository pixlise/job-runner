...
// Parameters:
//   - noop: Set to true for testing, it won't actually run commands (just print them) and won't log things
//     that vary per system (eg logging the working dir)
func RunJob(noop bool) error {
	testMode = noop
